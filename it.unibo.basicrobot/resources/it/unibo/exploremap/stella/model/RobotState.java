...
public class RobotState {
	...
	public RobotState(int x, int y, Direction direction, Goal goal) {
		...
		this.goal = goal;
//		System.out.println("RobotState CREATEDDDDDDDDDDDDDDDD " + "x="+x + "y="+y + "direction=" + direction + "goal=" + goal);
	}
	...
	public RobotState turnRight() {
		RobotState result = new RobotState(this.x, this.y, this.direction, this.goal);
